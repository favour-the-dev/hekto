...
const ProductCard = ({title, price, discount = 'none', imageUrl }: {title: string, price:string, discount:string, imageUrl:string}) => {
    return (
        <>
            <div className={`group flex-center flex-col gap-3 lg:max-w-[280px] w-full bg-[#F7F7F7] cursor-pointer relative hover:bg-white ease-in-out duration-300`}>
                {
                    discount !== 'none' && 
                ...
                <div className="ease-in-out duration-300 cursor-pointer flex-center flex-col gap-3 absolute left-2 bottom-[15%] text-xl opacity-0 group-hover:opacity-100">
